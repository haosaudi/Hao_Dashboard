...
const Category = (props) => {
  ...
  return (
    <>
      ...
      >
        <CCardHeader>Manage Gifts</CCardHeader>
        <Sortedtable
          dataArray={state.gifts}
          columns={[
            {
              label: "Design",
              field: "design",
...
const mapStateToProp = (state) => ({
  isLoading: state.GiftsReducer.isLoading,
...
const mapDispatchToProps = {
  GetAllGifts: GiftsAction.GetAllGifts,
